      ...
      <div className="d-flex align-items-center justify-content-between">
        ...
        <div className="right-widget ms-auto ms-lg-0 me-3 me-lg-0 order-lg-3">
          <ul className="d-flex align-items-center style-none">
            <li>
              <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal" className="btn-one"><i className="fa-regular fa-lock" /> <span>Login</span></a>
            </li>
            <li className="d-none d-md-inline-block ms-3">
              <a href="dashboard/add-property.html" className="btn-two" target="_blank"><span>Add Listing</span> <i className="fa-thin fa-arrow-up-right" /></a>
            </li>
          </ul>
        </div>
            ...
            <ul className="navbar-nav align-items-lg-center">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><a href="index.html" className="dropdown-item active"><span>Home 01</span></a></li>
                  ...
                  <li><a href="index-8.html" className="dropdown-item"><span>Home 08</span></a></li>
                </ul>
              </li>
              ...
              <li className="d-md-none ps-2 pe-2 mt-20">
                <a href="dashboard/add-property.html" className="btn-two w-100" target="_blank"><span>Add Listing</span> <i className="fa-thin fa-arrow-up-right" /></a>
              </li>
            </ul>
          </div>
        </nav>
